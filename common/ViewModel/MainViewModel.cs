    ...
    public class MainViewModel : NotificationObject
    {
        ...
        public static string AppTitleText
        {
            get
            {
                ...
                return string.Empty;
#else
             return "Syncfusion Controls Gallery for WinUI UWP"; 
#endif
            }
        }
...
#endif
#else
            bannerImage.UriSource = new Uri("ms-appx:///Syncfusion.DemosCommon.WinUI/Assets/BannerImageUWP.png");
#endif
        ...
        private void OnNavigationSelectionChanged(bool isThemeSwitchClicked)
        {
            ...
            else if (this.SelectedItem is DemoInfo demoInfo)
            {
                ...
                if (demoInfo.SubCategoryDemos?.Count > 0 && this.SubCategorySelectedItem != null && this.SubCategorySelectedItem is DemoInfo subDemoInfo)
                {
                    this.Header = subDemoInfo.Name;                    
                    NavigationService.DemoPageFrame.Navigate(subDemoInfo.DemoView, this);                    
                }
                else
                {
