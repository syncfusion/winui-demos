...
namespace Syncfusion.DemosCommon.WinUI
{
    ...
    public sealed partial class SectionGroupPage : Page
    {
        ...
        private void ControlRoot_PointerEntered(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (sender is Grid)
            {
                grid = sender as Grid;
                grid.Background = (Microsoft.UI.Xaml.Media.SolidColorBrush)this.Resources["SyncfusionControInfoHoverBackground"];
                grid.BorderBrush = (Microsoft.UI.Xaml.Media.SolidColorBrush)this.Resources["SyncfusionControInfoHoverBorderBrush"];
            }
            else if (sender is RelativePanel)
            {
        ...
        private void ControlRoot_PointerExited(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (sender is Grid)
            {
                grid = sender as Grid;
                grid.Background = (Microsoft.UI.Xaml.Media.SolidColorBrush)this.Resources["SyncfusionControlInfoBackground"];
                grid.BorderBrush = (Microsoft.UI.Xaml.Media.SolidColorBrush)this.Resources["SyncfusionControlInfoBorderBrush"];
            }
            else if (sender is RelativePanel)
            {
                relativePanel = sender as RelativePanel;
        ...
        private void ControlRoot_PointerPressed(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (sender is Grid)
            {
                grid = sender as Grid;
                grid.Background = (Microsoft.UI.Xaml.Media.SolidColorBrush)this.Resources["SyncfusionControInfoPressedBackground"];
                grid.BorderBrush = (Microsoft.UI.Xaml.Media.SolidColorBrush)this.Resources["SyncfusionControlInfoBorderBrush"];
            }
            else if (sender is RelativePanel)
            {
