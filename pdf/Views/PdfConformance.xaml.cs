    ...
    public sealed partial class PdfConformance : Page
    {
        ...
        private void GeneratePDF_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                Stream textfileStream = typeof(PdfConformance).GetTypeInfo().Assembly.GetManifestResourceStream("syncfusion.pdfdemos.winui.Assets.AdventureCycle.txt");
            ...
            Stream fontStream = typeof(PdfConformance).GetTypeInfo().Assembly.GetManifestResourceStream("syncfusion.pdfdemos.winui.Assets.arial.ttf");
            ...
            Stream imageStream = typeof(PdfConformance).GetTypeInfo().Assembly.GetManifestResourceStream("syncfusion.pdfdemos.winui.Assets.AdventureWork.png");
