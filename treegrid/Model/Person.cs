...
namespace TreeGrid
{
    public class Person : NotificationObject, INotifyDataErrorInfo, IDisposable
    {
        ...
        /// </summary>
        public Person()
            : this("Enter FirstName", "Enter LastName", new DateTimeOffset(new DateTime(2008, 10, 26)), new DateTimeOffset(new DateTime(2008, 10, 26,12,30,30)), 78998, "Mexico", "8692782389"," Enter Mail ID", null)
        {
        }
        ...
        public Person(string firstName, string lastName, DateTimeOffset? doj, DateTimeOffset? checkInTime, double? sal, string empCity, string contactnum, string mailid, ObservableCollection<Person> child)
        {
            FirstName = firstName;
            LastName = lastName;
            DOJ = doj;
