...
namespace Syncfusion.SchedulerDemos.WinUI
{
	...
	/// </summary>
	public sealed partial class LoadOnDemand : Page, IDisposable
	{
		public LoadOnDemand()
		{
		...
		public void Dispose()
		{
			...
			if (this.DataContext is LoadOnDemandViewModel)
			{
				(this.DataContext as LoadOnDemandViewModel).Dispose();
