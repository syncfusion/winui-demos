    ...
    public sealed partial class SleepTracker : Page, IDisposable
    {
        ...
        private void OnStartAnimation(bool isStart)
        {
            if (this.storyBoard == null)
            {
                ...
                DoubleAnimation doubleAnimation = this.GetDoubleAnimation(this.startPointer.MarkerHeight, this.startPointer.MarkerHeight + 10);
                ...
                Storyboard.SetTarget(doubleAnimation, isStart ? this.startPointer : this.EndPointer);

                doubleAnimation = this.GetDoubleAnimation(this.startPointer.MarkerWidth, this.startPointer.MarkerWidth + 10);
                this.storyBoard.Children.Add(doubleAnimation);
        ...
        private void OnEndAnimation(bool isStart)
        {
            if (this.storyBoard == null)
            {
                ...
                DoubleAnimation doubleAnimation = this.GetDoubleAnimation(this.startPointer.MarkerHeight + 10, this.startPointer.MarkerHeight);
                this.storyBoard.Children.Add(doubleAnimation);
                Storyboard.SetTargetProperty(doubleAnimation, nameof(Syncfusion.UI.Xaml.Gauges.MarkerPointer.MarkerHeight));
                Storyboard.SetTarget(doubleAnimation, isStart ? this.startPointer : this.EndPointer);

                doubleAnimation = this.GetDoubleAnimation(this.startPointer.MarkerWidth + 10, this.startPointer.MarkerWidth);
                this.storyBoard.Children.Add(doubleAnimation);
                Storyboard.SetTargetProperty(doubleAnimation, nameof(Syncfusion.UI.Xaml.Gauges.MarkerPointer.MarkerWidth));
                Storyboard.SetTarget(doubleAnimation, isStart ? this.startPointer : this.EndPointer);
