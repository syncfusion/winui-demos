...
namespace Syncfusion.ChartDemos.WinUI
{
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo financialChartSamples = new DemoInfo()
            {
            ...
            DemoInfo candleChartSample = new DemoInfo()
            {
                Name = "Candle",
                Category = "Basic Charts",
                DemoView = typeof(Views.CandleChart),
                ShowInfoPanel = true,
            };

            List<Documentation> candleChartDocumentation = new List<Documentation>()
            {
                new Documentation(){ Content = "Candle Series API Reference", Uri = new Uri("https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Charts.CandleSeries.html")},
                new Documentation(){ Content = "Candle Series Documentation", Uri = new Uri("https://help.syncfusion.com/winui/cartesian-charts/candle")},
            };
            candleChartSample.Documentation.AddRange(candleChartDocumentation);

            DemoInfo ohlcChartSample = new DemoInfo()
            {
                Name = "OHLC",
                Category = "Basic Charts",
                DemoView = typeof(Views.HiLoOpenCloseChart),
                ShowInfoPanel = true,
            };
            ...
            List<DemoInfo> subFinancialChartDemos = [candleChartSample, ohlcChartSample];

            financialChartSamples.SubCategoryDemos = subFinancialChartDemos;
