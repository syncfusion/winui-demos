    ...
    public sealed partial class SelectionBehavior : Page, IDisposable
    {
        ...
        private void UpdateSelection()
        {
            if(comboBox2 != null)
            {
                ...
                {
                    case 0:
                        dataPointSelection.Type = SelectionType.None;
                        break;
                    case 1:
                        dataPointSelection.Type = SelectionType.Single;
                        break;
                    case 2:
                        dataPointSelection.Type = SelectionType.Multiple;
                        break;
                }
            }
        }
        ...
        private void selection_SelectionChanged(object sender, UI.Xaml.Charts.SelectionChangedEventArgs e)
        {
            if (e.CurrentIndex == 0)
            {
