...
{
    public class DataPreprocessingAIService : AzureAIService
    {
        public async Task<ObservableCollection<DataPreprocessingModel>> GetCleanedData(ObservableCollection<DataPreprocessingModel> rawData)
        {
            ...
            if(AISettings.IsCredentialValid)
            {
                ...
                var response = await GetResponseFromGPT(prompt);
        ...
        internal ObservableCollection<DataPreprocessingModel> GetDummyData(ObservableCollection<DataPreprocessingModel> collection)
        {
            return new ObservableCollection<DataPreprocessingModel>() {
