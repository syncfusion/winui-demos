...
{
    public class StackedChartViewModel : IDisposable
    {
        ...
        public void Dispose()
        {
            if(StackedColumndData != null)
                StackedColumndData.Clear();

            if (StackedLinedData != null)
                StackedLinedData.Clear();

            if (StackedAreaData != null)
                StackedAreaData.Clear();
