...
{
    /// <summary>
    /// Provides the view model for column chart visualization.
    /// </summary>
    public class ColumnChartViewModel : IDisposable
    {
        /// <summary>
        /// Gets the default column chart data collection for basic visualization.
        /// </summary>
        public ObservableCollection<ColumnChartModel> DefaultColumnData { get; }

        /// <summary>
        /// Gets or sets the Olympic-themed color brushes used for chart styling.
        /// </summary>
        public ObservableCollection<Brush> OlympicColorModel { get; set; }

        /// <summary>
        /// Gets or sets the column chart data representing Olympic medal counts.
        /// </summary>
        public ObservableCollection<ColumnChartModel> OlympicMedals { get; set; }

        /// <summary>
        /// Gets or sets the alternate color brushes used for chart columns.
        /// </summary>
        public ObservableCollection<Brush> AlterColor { get; set; }

        /// <summary>
        /// Gets or sets the column chart data used for rounded column visualization.
        /// </summary>
