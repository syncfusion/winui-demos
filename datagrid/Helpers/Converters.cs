...
namespace DataGrid
{
    ...
    {
        /// <summary>
        /// The style applied to record cells conditionally based on data in SfDataGrid.
        /// </summary>
        /// <param name="item">The value produced by the binding source.</param>
        /// <param name="container">It contains the data value.</param>        
        /// <returns>
        /// A object that chooses the style to cell based on data. the default values is null.
        /// </returns>
