   ...
   public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            {
                Name = "AutoFit Content",
                Category = "Row",
                DemoType = DemoTypes.New,
                Description = "This sample showcases the auto fit content feature of DataGrid which improves the readability of the content and occurs on-demand basis.",
