   ...
   public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            gettingstartedDocumentations.Add(new Documentation() { Content = "DataGrid - CRUD Operations Documentation", Uri = new Uri("https://help.syncfusion.com/winui/datagrid/data-manipulation") });
            ...
            summariesDocumentations.Add(new Documentation() { Content = "DataGrid - GridTableSummaryRow API Reference", Uri = new Uri("https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.DataGrid.GridTableSummaryRow.html") });
            ...
            summariesDocumentations.Add(new Documentation() { Content = "DataGrid - CaptionSummaryRow API Reference", Uri = new Uri("https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.DataGrid.CaptionSummaryRowControl.html") });
            ...
            datavalitationsDocumentations.Add(new Documentation() { Content = "DataGrid - Built-In Data Validation Documentation", Uri = new Uri("https://help.syncfusion.com/winui/datagrid/data-validation#built-in-validation-using-inotifydataerrorinfo") });
            ...
            datavalitationsDocumentations.Add(new Documentation() { Content = "DataGrid - Data Validation Customization Documentation", Uri = new Uri("https://help.syncfusion.com/winui/datagrid/data-validation#showing-error-details-in-rowheader") });
