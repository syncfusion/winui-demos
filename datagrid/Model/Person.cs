...
namespace DataGrid
{
    public class Person : NotificationObject
    {
        ...
        public Person(bool selected, string name, string designation, string mail, string location, string trust, int rating, string status, double proficiency, int salary, string address, string gender)
        {
            Selected = selected;
            EmployeeName = name;
