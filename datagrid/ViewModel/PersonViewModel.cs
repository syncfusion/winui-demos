...
namespace DataGrid
{
    public class PersonViewModel : IDisposable
    {
        ...
        private ObservableCollection<Person> persons;
            ...
            public List<string> Trustworthiness { get; }
        ...
        "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", "Magazinweg 7", "Taucherstraße 10", "Taucherstraße 10"};
            ...
            for (int i = 10000; i < count + 10000; i++)
            {
                ...
                ordersDetails.Add(new Person(i % 2 == -1, name, designation[random.Next(6)], name.ToLower(CultureInfo.CurrentCulture) + "@" + mail[random.Next(4)], location[random.Next(8)], trust[random.Next(3)], random.Next(1, 5), status[random.Next(2)], random.Next(1, 100), random.Next(100000, 400000), address[random.Next(1, 25)], gender));
            }
