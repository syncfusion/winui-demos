...
namespace DataGrid
{
    ...
    public sealed partial class Printing : Page, IDisposable
    {
        ...
        public void Dispose()
        {
            this.btnPrint.Click -= OnPrintBtnClick;
            ...
            if (ckbCanPrintStackedHeaders != null)
                ckbCanPrintStackedHeaders = null;

            if (ckbCanRepeatHeaders != null)
                ckbCanRepeatHeaders = null;

            if (ckbFitColumnsOnSinglePage != null)
                ckbFitColumnsOnSinglePage = null;
