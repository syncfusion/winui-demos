...
namespace Syncfusion.KanbanDemos.WinUI
{
    ...
    /// </summary>
    public sealed partial class Sorting : Page, IDisposable
    {
        #region Fields
        ...
        private void OnKanbanCardDrop(object sender, KanbanCardDropEventArgs e)
        {
            ...
            if (this.kanban == null || this.targetColumn == null || this.selectedCard == null || this.sortBySelection == null || this.sortBySelection.SelectedItem == null)
            {
                return;
            }
            ...
            string selectedValue = this.sortBySelection.SelectedItem.ToString() ?? string.Empty;
        ...
        private void OnSortByComboBoxSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (this.kanban == null || this.sortBySelection == null || this.sortBySelection.SelectedItem == null || sender is not ComboBox)
            {
                return;
            }

            string selectedItem = this.sortBySelection.SelectedItem.ToString() ?? string.Empty;
            switch (selectedItem)
            {
                case "Index":
        ...
        /// <param name="sender">The object.</param>
        /// <param name="e">The event args.</param>
        private void OnSortMappingPathSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            var selectedItem = (sender as ComboBox)?.SelectedItem?.ToString();
        ...
        private void UpdateProgressOnColumnChange(KanbanCardDropEventArgs e)
        {
            if (e == null || this.selectedCard == null || this.selectedCard.Content is not CardDetails cardDetails || e.SourceColumn == null || e.TargetColumn == null)
            {
                return;
            }

            // Get source and target category from the column's categories
            string sourceCategory = e.SourceColumn.Categories;
        ...
        {
            if (this.sortOrderComboBox == null || this.sortBySelection == null || this.sortBySelection.SelectedItem == null || this.mappingPathComboBox == null)
            {
                return;
            }

            var selectedItem = this.sortBySelection.SelectedItem.ToString() ?? string.Empty;
            ...
            this.sortOrderComboBox.IsEnabled = !isItemSourceOrder;
        }
