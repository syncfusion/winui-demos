    ...
    public sealed partial class DialogEditing : Page, IDisposable
    {
        ...
        private async void ShowCardEditDialog(KanbanModel cardContent)
        {
            ...
            if (result == ContentDialogResult.Primary)
            {
                ...
                if (cardContent.Assignee != card.Assignee || cardContent.Category.ToString() != card.Category.ToString())
                {
                ...
                {
                    cardContent.Title = titleTextBox.Text;
                    cardContent.IndicatorColorKey = (priorityComboBox.SelectedItem as ComboBoxItem)?.Content.ToString();
                    cardContent.Description = summaryTextBox.Text;
                }
            }
