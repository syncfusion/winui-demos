...
namespace syncfusion.editordemos.winui
{
    public class ListViewModel : NotificationObject
    {
        ...
        private void PopulateSelectionBoxCountryListData()
        {
            ...
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/UnitedStates.png", UriKind.RelativeOrAbsolute)),
                CountryName = "United States"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/turkey.png", UriKind.RelativeOrAbsolute)),
                CountryName = "Turkey"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/Mexico.png", UriKind.RelativeOrAbsolute)),
                CountryName = "Mexico"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/Basque.png", UriKind.RelativeOrAbsolute)),
                CountryName = "Basque"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/India.png", UriKind.RelativeOrAbsolute)),
                CountryName = "India"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/Portugal.png", UriKind.RelativeOrAbsolute)),
                CountryName = "Portugal"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/UnitedKingdom.png", UriKind.RelativeOrAbsolute)),
                CountryName = "United Kingdom"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/france.png", UriKind.RelativeOrAbsolute)),
                CountryName = "France"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/china.png", UriKind.RelativeOrAbsolute)),
                CountryName = "China"
            });

            this.SelectionBoxCountryList.Add(new CountryInfo
            {
                FlagImage = new BitmapImage(new Uri(@"ms-appx:///Assets/NumberBox/Russia.png", UriKind.RelativeOrAbsolute)),
                CountryName = "Russia"
            });
        }
