...
namespace syncfusion.treeviewdemos.winui
{
    public class SamplesConfiguration 
    {
        public SamplesConfiguration()
        {
            ...
            gettingStartedSampleDocumentation.Add(new Documentation() { Content = "TreeView - Data Populations Documentation", Uri = new Uri("https://help.syncfusion.com/winui/treeview/data-population") });
            ...
            nodeWithImageSampleDocumentation.Add(new Documentation() { Content = "TreeView - TreeNode Expand and Collapse Documentation", Uri = new Uri("https://help.syncfusion.com/winui/treeview/expand-collapse#events") });
