...
namespace syncfusion.calendardemos.winui.Views.CalendarDateRangePicker
{
    ...
    public sealed partial class CalendarDateRangePickerView : Page
    {
        ...
        private void languages_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                calendarDateRangePicker3.Language = selectedLang;
            }
        }
        ...
        private void ListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                DateTimeOffset startdate = DateTimeOffset.Now.AddDays(-(DateTimeOffset.Now.DayOfWeek - calendarDateRangePicker2.FirstDayOfWeek));
        ...
        {
            if (listBox != null && e.RangeStartNewValue != null && e.RangeEndNewValue == null)
            {
