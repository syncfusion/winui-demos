    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo latex = new()
            {
                ...
                Description = "This sample demonstrates how to create a Word document with mathematical equation using LaTeX using the .NET Word (DocIO) library.",
                DemoView = typeof(LaTeX),
                ShowInfoPanel = true
            };
            selectionDocumentations = new List<Documentation>
            {
                new Documentation() { Content = "Word library - LaTeX", Uri = new Uri("https://help.syncfusion.com/file-formats/docio/working-with-mathematical-equation") }
            };
            latex.Documentation.AddRange(selectionDocumentations);
