...
namespace Syncfusion.RibbonDemos.WinUI.Views.Ribbon
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RibbonGalleryView"/> class.
        /// </summary>
        ...
        public void Dispose()
        {
            ...
            {
                this.ribbonGallery.Dispose();
                this.ribbonGallery = null;
            }

            if (this.ribbonGallery1 != null)
            {
                this.ribbonGallery1.Dispose();
                this.ribbonGallery1 = null;
            }
