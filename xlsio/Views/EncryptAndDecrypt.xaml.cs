    ...
    public partial class EncryptAndDecrypt : Page
    {
        ...
        {            
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                string inputPath = "syncfusion.xlsiodemos.winui.Assets.XlsIO.Encrypt.xlsx";
        ...
        {           
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                string inputPath = "syncfusion.xlsiodemos.winui.Assets.XlsIO.EncryptedSpreadsheet.xlsx";
