...
namespace syncfusion.notificationdemos.winui
{
    ...
    {
        private BadgeShape badgeShape = BadgeShape.Oval;
        ...
        public BadgeViewModel()
        {
            ...
            MailItems.Add(new MailInfo() { ItemName = "Sent Items", UnreadMessageount = 5 });
